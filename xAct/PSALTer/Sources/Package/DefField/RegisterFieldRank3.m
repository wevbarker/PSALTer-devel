...
xAct`PSALTer`Private`DefSO3Irrep[Rank3AntiPara0p[],Spin->0,Parity->Even];
xAct`PSALTer`Private`DefSO3Irrep[Rank3AntiPara0m[],Spin->0,Parity->Odd];
xAct`PSALTer`Private`DefSO3Irrep[Rank3AntiPara1p[-a,-b],Antisymmetric[{-a,-b}],Spin->1,Parity->Even];
xAct`PSALTer`Private`DefSO3Irrep[Rank3AntiPara1m[-a],Spin->1,Parity->Odd];
xAct`PSALTer`Private`DefSO3Irrep[Rank3AntiPara2p[-a,-b],Symmetric[{-a,-b}],Spin->2,Parity->Even];
xAct`PSALTer`Private`DefSO3Irrep[Rank3AntiPara2m[-a,-b,-c],Antisymmetric[{-a,-b}],Spin->2,Parity->Odd];
xAct`PSALTer`Private`DefSO3Irrep[Rank3AntiPerp1p[-a,-b],Antisymmetric[{-a,-b}],Spin->1,Parity->Even];
xAct`PSALTer`Private`DefSO3Irrep[Rank3AntiPerp1m[-a],Spin->1,Parity->Odd];
xAct`PSALTer`Private`DefSO3Irrep[Rank3SymmPerpT0p[],Spin->0,Parity->Even];
xAct`PSALTer`Private`DefSO3Irrep[Rank3SymmPerpT1m[-i],Spin->1,Parity->Odd];
xAct`PSALTer`Private`DefSO3Irrep[Rank3SymmPara0p[],Spin->0,Parity->Even];
xAct`PSALTer`Private`DefSO3Irrep[Rank3SymmPara2p[-i,-j],Symmetric[{-i,-j}],Spin->2,Parity->Even];
xAct`PSALTer`Private`DefSO3Irrep[Rank3SymmParaT1m[-i],Spin->1,Parity->Odd];
xAct`PSALTer`Private`DefSO3Irrep[Rank3SymmPara3m[-i,-j,-a],Symmetric[{-i,-j,-a}],Spin->3,Parity->Odd];
xAct`PSALTer`Private`DefSO3Irrep[Rank3SymmPerpH1m[-i],Spin->1,Parity->Odd];
xAct`PSALTer`Private`DefSO3Irrep[Rank3SymmPara1p[-i,-a],Antisymmetric[{-i,-a}],Spin->1,Parity->Even];
xAct`PSALTer`Private`DefSO3Irrep[Rank3SymmPerpH0p[],Spin->0,Parity->Even];
xAct`PSALTer`Private`DefSO3Irrep[Rank3SymmPerp2p[-i,-j],Symmetric[{-i,-j}],Spin->2,Parity->Even];
xAct`PSALTer`Private`DefSO3Irrep[Rank3SymmParaH1m[-i],Spin->1,Parity->Odd];
xAct`PSALTer`Private`DefSO3Irrep[Rank3SymmPara2m[-i,-j,-a],Antisymmetric[{-i,-j}],MultiTermSymmetries->{Rank3SymmPara2m[-i,-j,-a]+Rank3SymmPara2m[-a,-i,-j]+Rank3SymmPara2m[-j,-a,-i]},Spin->2,Parity->Odd];
