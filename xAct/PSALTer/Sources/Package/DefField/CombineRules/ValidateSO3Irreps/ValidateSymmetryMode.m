...
DefField::NoSymmMode="The symmetries of the reduced-index mode `1` are `2`, but these appear not to match the symmetries of the mode when it is expanded into fundamental fields, which are `3`; this may indicate that the provided rules are incorrect.";
