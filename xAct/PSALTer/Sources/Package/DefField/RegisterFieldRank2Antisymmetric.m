...
xAct`PSALTer`Private`DefSO3Irrep[Rank2AntisymmetricPara1p[-a,-b],Antisymmetric[{-a,-b}],Spin->1,Parity->Even];
xAct`PSALTer`Private`DefSO3Irrep[Rank2AntisymmetricPerp1m[-a],Spin->1,Parity->Odd];
