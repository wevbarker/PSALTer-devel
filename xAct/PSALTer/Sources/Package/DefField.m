...
DefFieldActual[InputField_[Inds___],SymmExpr_,OptionsPattern[]]:=Module[{
	...
	Which[
		...
		BuildPackage@"DefField/RegisterFieldRank3Antisymmetric12.m",
		(Rank===3)&&(Type===Antisymmetric)&&((Pair==={1,3})||(Pair==={3,1})),
		BuildPackage@"DefField/RegisterFieldRank3Antisymmetric13.m",
		(Rank===3)&&(Type===Antisymmetric)&&((Pair==={2,3})||(Pair==={3,2})),
		BuildPackage@"DefField/RegisterFieldRank3Antisymmetric23.m",
		(Rank===3)&&(Type===Antisymmetric)&&((Pair==={1,2,3})||(Pair==={1,3,2})||(Pair==={2,1,3})||(Pair==={3,1,2})||(Pair==={2,3,1})||(Pair==={3,2,1})),
		BuildPackage@"DefField/RegisterFieldRank3TotallyAntisymmetric.m",
		(Rank===3)&&(Type===Symmetric)&&((Pair==={1,2})||(Pair==={2,1})),
		BuildPackage@"DefField/RegisterFieldRank3Symmetric12.m",
		(Rank===3)&&(Type===Symmetric)&&((Pair==={1,3})||(Pair==={3,1})),
		BuildPackage@"DefField/RegisterFieldRank3Symmetric13.m",
		(Rank===3)&&(Type===Symmetric)&&((Pair==={2,3})||(Pair==={3,2})),
		BuildPackage@"DefField/RegisterFieldRank3Symmetric23.m",
		(Rank===3)&&(Type===Symmetric)&&((Pair==={1,2,3})||(Pair==={1,3,2})||(Pair==={2,1,3})||(Pair==={3,1,2})||(Pair==={2,3,1})||(Pair==={3,2,1})),
		BuildPackage@"DefField/RegisterFieldRank3TotallySymmetric.m",
		True,
