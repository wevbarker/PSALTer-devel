...
Get@FileNameJoin@{$ThisDirectory,"Documentation","WeylGaugeTheoryExtended","LagrangianWGTECouplings.m"};
Get@FileNameJoin@{$ThisDirectory,"Documentation","WeylGaugeTheoryExtended","LineariseWGTE.m"};
Get@FileNameJoin@{$ThisDirectory,"Documentation","WeylGaugeTheoryExtended","GaugeMapperWGTE.m"};
Get@FileNameJoin@{$ThisDirectory,"Documentation","WeylGaugeTheoryExtended","LagrangianWGTEScaleInvariantRescaling.m"};
Get@FileNameJoin@{$ThisDirectory,"Documentation","WeylGaugeTheoryExtended","GaugeSelectorWGTE.m"};
Get@FileNameJoin@{$ThisDirectory,"Documentation","WeylGaugeTheoryExtended","WGTEGeneralCase.m"};
