...
LinearisedLagrangian=Get@FileNameJoin@{$ThisDirectory,"Documentation","ScalarTensorTheory","ScalarGaussBonnetTheory","GeneralLambda.txt"};
...
Get@FileNameJoin@{$ThisDirectory,"Documentation","ScalarTensorTheory",
