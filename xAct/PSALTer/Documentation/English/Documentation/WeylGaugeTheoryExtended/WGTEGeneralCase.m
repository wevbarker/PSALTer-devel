...
DocumentationTimingDataWGTECases=MapThread[
...
DisplayExpression@DocumentationTimingDataWGTECases;
(*DumpSave[FileNameJoin@{NotebookDirectory[],"DocumentationTimingDataWGTECases.mx"},{DocumentationTimingDataWGTECases}];*)
