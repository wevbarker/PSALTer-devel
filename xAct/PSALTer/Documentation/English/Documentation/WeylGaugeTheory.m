...
Get@FileNameJoin@{NotebookDirectory[],"Documentation","WeylGaugeTheory","LagrangianLinWeylCouplings.m"};
Get@FileNameJoin@{NotebookDirectory[],"Documentation","WeylGaugeTheory","LineariseLinWeyl.m"};
...
(*Get@FileNameJoin@{NotebookDirectory[],"Documentation","WeylGaugeTheory","WeylSimpleTestCases.m"};*)
(*Get@FileNameJoin@{NotebookDirectory[],"Documentation","WeylGaugeTheory","WeylGeneralCase.m"};*)
(*Get@FileNameJoin@{NotebookDirectory[],"Documentation","WeylGaugeTheory","LinWeylCriticalCasesGeneral.m"};*)
Get@FileNameJoin@{NotebookDirectory[],"Documentation","WeylGaugeTheory","LinWeylCriticalCasesZeroTorsion.m"};
(*Get@FileNameJoin@{NotebookDirectory[],"Documentation","WeylGaugeTheory","LinWeylCriticalCasesZeroCurvature.m"};*)
