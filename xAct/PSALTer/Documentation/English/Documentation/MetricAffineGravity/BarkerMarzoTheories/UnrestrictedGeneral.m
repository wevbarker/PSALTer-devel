...
Comment@{"So generically from",Cref@"UnrestrictedGeneral"," we expect a massless higher-spin particle and also a pair of positive- and negative-parity massive vectors."};
