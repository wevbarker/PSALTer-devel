...
Comment@"This improves the formatting of the final output graphic. If you are having problems with the production of this graphic (especially for macOS or Microsoft Windows users), and just want to do science with PSALTer without high-quality output graphics, you should run this line (a temporary fix):";
Code[(*xAct`PSALTer`Private`$NoExport=True;*)];
