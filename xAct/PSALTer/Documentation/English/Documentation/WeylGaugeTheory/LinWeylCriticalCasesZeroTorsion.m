...
Get@FileNameJoin@{NotebookDirectory[],"Documentation","WeylGaugeTheory","WeylCriticalCasesData","CriticalCasesLinWeylZeroTorsion.m"};
Get@FileNameJoin@{NotebookDirectory[],"Documentation","WeylGaugeTheory","WeylCriticalCasesData","UnitarityInfoLinWeylZeroTorsion.m"};
Get@FileNameJoin@{NotebookDirectory[],"Documentation","WeylGaugeTheory","WeylCriticalCasesData","CalibrateCaseLinWeylZeroTorsion.m"};
...
DocumentationTimingDataLinWeylZeroTorsion=MapThread[
...
DisplayExpression@DocumentationTimingDataLinWeylZeroTorsion;

(*DumpSave[FileNameJoin@{NotebookDirectory[],"DocumentationTimingDataLinWeylZeroTorsion.mx"},{DocumentationTimingDataLinWeylZeroTorsion}];*)
