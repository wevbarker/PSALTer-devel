...
CarloTestTheory[RuleSet_]:=Module[{LinearLagrangian},
	...
	Comment@{"So imposing",Cref@("RuleSet"<>ToString@CaseNumber)," on the theory in",Cref@"MetricAffineRicciTypeTheory"," we obtain the following."};
...
CarloTestTheory/@CarloSolutions;
