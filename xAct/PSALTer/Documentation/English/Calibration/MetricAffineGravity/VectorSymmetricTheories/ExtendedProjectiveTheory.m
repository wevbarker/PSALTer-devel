...
Comment@{"In the most general form",Cref@"ExtendedProjectiveTheory",", the theory has a symmetry which is cumbersome to express in terms of the remaining couplings. We therefore take an arbitrary case of the theory."};
LinearLagrangian=LinearLagrangian/.ReductionRules;
DisplayExpression[LinearLagrangian,EqnLabel->"ExtendedProjectiveTheoryReduced"];

Comment@{"First we study",Cref@"ExtendedProjectiveTheoryReduced"," in the first-order formulation."};
