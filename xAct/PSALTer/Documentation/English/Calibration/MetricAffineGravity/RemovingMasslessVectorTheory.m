...
RemovingMasslessVectorConstraint={xAct`PSALTer`MetricAffineGravity`C9->xAct`PSALTer`MetricAffineGravity`C10-xAct`PSALTer`MetricAffineGravity`C11+xAct`PSALTer`MetricAffineGravity`C12+16xAct`PSALTer`MetricAffineGravity`C13-xAct`PSALTer`MetricAffineGravity`C7+xAct`PSALTer`MetricAffineGravity`C8,xAct`PSALTer`MetricAffineGravity`C15->(8xAct`PSALTer`MetricAffineGravity`C13-xAct`PSALTer`MetricAffineGravity`C14)/8};
