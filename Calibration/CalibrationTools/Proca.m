...
LinearisedLagrangian=Coupling1*(CD[-a]@xAct`PSALTer`Proca`B[-b]-CD[-b]@xAct`PSALTer`Proca`B[-a])*(CD[a]@xAct`PSALTer`Proca`B[b]-CD[b]@xAct`PSALTer`Proca`B[a]);
...
ParticleSpectrum[
	...
	TensorFields->{xAct`PSALTer`Proca`B},
...
(*====================================*)
(*  Proca field (electroweak bosons)  *)
(*====================================*)

Title@"Proca field (electroweak bosons)";
...
LinearisedLagrangian=Coupling1*(CD[-a]@xAct`PSALTer`Proca`B[-b]-CD[-b]@xAct`PSALTer`Proca`B[-a])*(CD[a]@xAct`PSALTer`Proca`B[b]-CD[b]@xAct`PSALTer`Proca`B[a])+Coupling3*xAct`PSALTer`Proca`B[-a]*xAct`PSALTer`Proca`B[a];
Print@LinearisedLagrangian;
...
LinearisedLagrangian=Coupling1*CD[-a]@xAct`PSALTer`Proca`B[-b]*CD[a]@xAct`PSALTer`Proca`B[b]+Coupling2*CD[-a]@xAct`PSALTer`Proca`B[a]*CD[-b]@xAct`PSALTer`Proca`B[b];
Print@LinearisedLagrangian;
...
LinearisedLagrangian=Coupling1*CD[-a]@xAct`PSALTer`Proca`B[-b]*CD[a]@xAct`PSALTer`Proca`B[b]+Coupling2*CD[-a]@xAct`PSALTer`Proca`B[a]*CD[-b]@xAct`PSALTer`Proca`B[b]+Coupling3*xAct`PSALTer`Proca`B[-a]*xAct`PSALTer`Proca`B[a];
Print@LinearisedLagrangian;
